"""
Django settings for prac_proj_thm_7 project.
...
SECRET_KEY = 'django-insecure-9x$delvm=h2l*yta$3p=%taiv^u%%wd%px^fm8sk9mk)j@m(td'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['django-perm.herokuapp.com', '127.0.0.1']
...
STATIC_ROOT = os.path.join(BASE_DIR_2, 'collected_static')
